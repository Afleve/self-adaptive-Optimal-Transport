...
if __name__ == "__main__":
    ...
    parser.add_argument('--image_fg', default=True, help='Set to run image feature generation')
    parser.add_argument('--text_fg', default=False, help='Set to run text feature generation')
    ...
    # parser.add_argument('--model_names', nargs='+', default=["SkyCLIP50"], help='List of model names')
    ...
    parser.add_argument('--dataset_names', nargs='+', default=["RSICB128"], help='List of dataset names')
