...
class WSSS4LUAD(DatasetBase):
    dataset_dir ="WSSS4LUAD"

    def __init__(self, root, preprocess):
        self.root = root
        self.dataset_dir = os.path.join(root, self.dataset_dir)
        self.dataset_test = os.path.join(self.dataset_dir, "label_csv/trainratio=0.70_size=224/WSSS4LUAD_binary_test.csv")
        self.dataset_train = os.path.join(self.dataset_dir, "label_csv/trainratio=0.70_size=224/WSSS4LUAD_binary_train.csv")
